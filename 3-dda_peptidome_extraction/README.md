...
These files are **not included in this repository** because they are typically large and dataset-specific. Instead, users should provide their own directory containing Percolator peptide output files from their database search workflow.
